...
.menu-box {
 ...
 // align-items: center;
  .menu-item {
    ...
    &:nth-child(1) {
      .menu-img {
        background-image: url(/gym/dist/menu1.png);
        background-position: 0 -10px;
      }
    }
    &:nth-child(2) {
      .menu-img {
        background-image: url(/gym/dist/menu2.png);
      }

    }
    &:nth-child(3) {
      .menu-img {
        background-image: url(/gym/dist/menu3.jpg);
    ...
    &:nth-child(4) {
      .menu-img {
        background-image: url(/gym/dist/menu4.png);
      }
